...
import { copyProject } from "@app/kernel/server/project-service";

/**
 * /api/workbench/projects/[id]/copy — 复制一个沙盘项目（Phase 4 模块 B，§四「复制」）。
 *
...
export async function POST(
  ...
  const result = await copyProject(id, parsed.data, { user: actor.user });
