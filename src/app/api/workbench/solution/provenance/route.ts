...
/**
 * POST /api/workbench/solution/provenance — 提交「真实来源链接 + 置信度」，把某条沙盘来源 `SolutionFinancial`
 ...
 *   ★V1.1 P4 刻意例外：同族「买家导出」端点（/api/workbench/solution、/api/workbench/source/solutions）
